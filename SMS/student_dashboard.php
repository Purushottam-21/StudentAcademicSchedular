...
<body>
	<div id="header"><br>
		<center>Student Academic Schedular &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Welcome <?php echo $_SESSION['name'];?> 
		<a href="logout.php">Logout</a>
		</center>
	</div>
	<span id="top_span"><marquee style="color: red;">Note:- This portal is open till 30 November 2021...Plz edit your information, if wrong.</marquee></span>
	<div id="left_side">
		<br><br><br>
